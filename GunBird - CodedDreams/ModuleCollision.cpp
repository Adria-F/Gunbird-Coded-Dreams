...
ModuleCollision::ModuleCollision()
{
	...
	matrix[COLLIDER_DECORATION][COLLIDER_PLAYER_SHOT] = true;
	...
	matrix[COLLIDER_AIR_ENEMY][COLLIDER_PLAYER_SHOT] = true;
	...
	matrix[COLLIDER_PLAYER_SHOT][COLLIDER_DECORATION] = true;
	matrix[COLLIDER_PLAYER_SHOT][COLLIDER_PLAYER] = false;
	matrix[COLLIDER_PLAYER_SHOT][COLLIDER_ENEMY] = true;
	matrix[COLLIDER_PLAYER_SHOT][COLLIDER_PLAYER_SHOT] = false;
	matrix[COLLIDER_PLAYER_SHOT][COLLIDER_ENEMY_SHOT] = false;
	matrix[COLLIDER_PLAYER_SHOT][COLLIDER_POWER_UP] = false;
	matrix[COLLIDER_PLAYER_SHOT][COLLIDER_AIR_ENEMY] = true;
