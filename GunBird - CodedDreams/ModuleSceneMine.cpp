...
bool ModuleSceneMine::Start()
{
	...
	App->enemies->AddEnemy(DRONE, -50, 3020+70, 1, 3);
	App->enemies->AddEnemy(DRONE, -50, 3040+70, 1, 2);
	//Drones wave2->Done
	...
	App->enemies->AddEnemy(DRONE, -50, 2800, 1, 3);
	App->enemies->AddEnemy(DRONE, -50, 2820, 1, 2);
	//Drones wave6
	...
	App->enemies->AddEnemy(FALLING_DRONE, -75, 2450, 1, 1);
	App->enemies->AddEnemy(FALLING_DRONE, -35, 2450, 1, 1);
	App->enemies->AddEnemy(FALLING_DRONE, -55, 2490, 1, 2);
