...
ModuleCollision::ModuleCollision()
{
	...
	matrix[COLLIDER_WALL][COLLIDER_DROPPING_ENEMY] = false;
	...
	matrix[COLLIDER_ENEMY][COLLIDER_BUILDING] = true;

	matrix[COLLIDER_DROPPING_ENEMY][COLLIDER_WALL] = false;
	matrix[COLLIDER_DROPPING_ENEMY][COLLIDER_PLAYER] = true;
	...
	matrix[COLLIDER_DROPPING_ENEMY][COLLIDER_BUILDING] = true;
	...
	matrix[COLLIDER_ENEMY_SHOT][COLLIDER_PLAYER] = false;//true
